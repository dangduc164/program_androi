...
public class dua4 extends AppCompatActivity {
    ...
    ImageButton play;
    TextView txtdiem;
    SeekBar thanh1,thanh2,thanh3,thanh4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgbtnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(dua4.this,MainActivity.class);
        ...
        CountDownTimer dongho = new CountDownTimer(60000,500) {
            ...
            public void onTick(long l) {
                ...
                if(thanh1.getProgress() == 100){
                    this.cancel();
                    Toast.makeText(dua4.this,"S1 Thắng!",Toast.LENGTH_SHORT).show();
                    if (check1.isChecked()){
                        ketqua= ketqua+10;
                    }else {
                        ketqua = ketqua-10;
                    ...
                    this.cancel();
                    Toast.makeText(dua4.this,"S2 Thắng!",Toast.LENGTH_SHORT).show();
                    if (check2.isChecked()){
                        ketqua= ketqua+10;
                    }else {
                        ketqua = ketqua-10;
                    ...
                    this.cancel();
                    Toast.makeText(dua4.this,"S3 Thắng!",Toast.LENGTH_SHORT).show();
                    if (check3.isChecked()){
                        ketqua= ketqua+10;
                    }else {
                        ketqua = ketqua-10;
                    ...
                    check3.setEnabled(true);
                    check4.setEnabled(true);
                }else if(thanh4.getProgress()==100){
                    this.cancel();
                    Toast.makeText(dua4.this,"S3 Thắng!",Toast.LENGTH_SHORT).show();
                    if (check3.isChecked()){
                        ketqua= ketqua+10;
                    ...
                    thanh4.setProgress(thanh4.getProgress() + random4);
                }
            }
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(check1.isChecked()|| check2.isChecked()|| check3.isChecked()|| check4.isChecked()){
                    ...
                    Toast.makeText(dua4.this,"Vui lòng đặt cược",Toast.LENGTH_SHORT).show();
                }
    ...
    protected void  anhxa(){
        ...
        thanh4 = (SeekBar) findViewById(R.id.thanh4);
